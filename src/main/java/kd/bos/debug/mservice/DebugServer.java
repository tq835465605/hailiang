...
//		System.setProperty(ConfigUtils.CONFIG_URL_KEY, "127.0.0.1:2181");
		System.setProperty(ConfigUtils.CLUSTER_NAME_KEY, "ierp");//群集编码
		System.setProperty(ConfigUtils.CONFIG_URL_KEY, "172.17.15.183:2181");
...
//	    System.setProperty("lightweightdeploy","true");//是否轻量级启动
...
//	    System.setProperty("domain.tenantCode","cosmic-simple");//租户编码
	    System.setProperty("domain.tenantCode","hailiangtest");//租户编码
...
//	    System.setProperty("imageServer.url","http://127.0.0.1:8100/fileserver/");
		System.setProperty("fileserver","http://172.17.15.183:8100/fileserver/");
	    System.setProperty("imageServer.url","http://172.17.15.183:8100/fileserver/");
	    
	    System.setProperty("bos.app.special.deployalone.ids","");
//		System.setProperty("mc.server.url","http://127.0.0.1:8090/");
		System.setProperty("mc.server.url","http://172.17.15.183:8090/mc");
